...
public class SensorsFragmentActivity extends PreferenceFragment {
    ...
    private static final String TAG = "InfuseParts_General";
    ...
    public static void restore(Context context) {
        ...
        String accelerometerCalib = sharedPrefs.getString(DeviceSettings.KEY_USE_ACCELEROMETER_CALIBRATION, "1");
        ...
        if (accelerometerCalib.compareTo("1") != 0)
            Utils.writeValue(FILE_USE_ACCELEROMETER_CALIB, accelerometerCalib);
